...
public class Ventana extends JFrame implements ActionListener {
	...
	private void iniciarComponentes() {
		...
		/*
		 * con esto definmos nosotros mismos los tamaños y posicion de los
		 * componentes
		 */
		...
		/*
		 * Propiedades del boton, lo instanciamos, posicionamos y activamos los
		 * eventos
		 */
		agregar = new JButton();
		...
		/*
		 * Propiedades del Label, lo instanciamos, posicionamos y activamos los
		 * eventos
		 */
